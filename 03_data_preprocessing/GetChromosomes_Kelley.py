...
df_trans = df.loc[df['feature'] == "transcript"]

f = open("D:/Documents/Bioinformatik/Master/ML/project_1/data/Kelley_et_al_chromosomes.txt", "w")
f.write("GeneID\tChromosome\n")

for index, row in df_trans.iterrows():
    f.write(row["geneID"] + "\t" + row["seqname"] + "\n")
